...
export enum Command {
  ...
  GENERATE_EVAL = 'app.generateEval',
...
export const defaultKeyBindingConfig: KeyBindingConfig = new Map([
  ...
  [Command.GENERATE_EVAL, [new KeyBinding('ctrl+q')]],
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.GENERATE_EVAL]:
    'Generate an eval-rule combo from the last detected misbehavior.',
  [Command.CYCLE_APPROVAL_MODE]:
