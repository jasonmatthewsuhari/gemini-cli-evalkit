...
describe('loadCliConfig approval mode', () => {
  ...
  it('should set wildcard approval mode when --yolo flag is used', async () => {
    process.argv = ['node', 'script.js', '--yolo'];
    const argv = await parseArguments(createTestMergedSettings());
    const config = await loadCliConfig(
      createTestMergedSettings(),
  ...
  it('should set wildcard approval mode when -y flag is used', async () => {
  ...
  it('should set wildcard approval mode when --approval-mode=yolo', async () => {
